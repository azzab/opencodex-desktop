...
在 OpenCodex Desktop 里，品味意味着清晰的流程、克制的界面、自然的文案，以及用一次就能理解的行为。好的贡献不只是把功能做出来，也要体现判断力。
...
一个结构良好的 OpenCodex Desktop PR 应该聚焦且自包含。通常：
...
- 操作系统及版本
- OpenCodex Desktop 版本（可在设置页或关于对话框查看）
...
向 OpenCodex Desktop 贡献代码即表示你同意你的贡献将基于 [MIT 许可证](../LICENSE) 发布。
