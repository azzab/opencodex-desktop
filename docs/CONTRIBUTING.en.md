...
Thank you for contributing to OpenCodex Desktop.
...
For OpenCodex Desktop, taste means clear workflows, restrained interfaces, humane copy, and behavior that feels obvious after one use. Strong contributions show judgment, not just implementation.
...
A well-structured PR for OpenCodex Desktop is focused and self-contained. It typically:
...
- OpenCodex Desktop version (from Settings or the About dialog)
...
By contributing to OpenCodex Desktop, you agree that your contributions will be licensed under the [MIT License](../LICENSE).
