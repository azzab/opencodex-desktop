...
| 6 | H6 Browser Automation Sidecar | `oc-h6-browser` | dsv4-pro max | 🟡 | initial READY rejected: $0.5786 / in 538,383 out 233,780 cacheRead 38,910,848 cache 98.6%; remediation1 rejected: $0.5525 / in 706,017 out 150,481 cacheRead 31,565,952 cache 97.8%; remediation2 rejected: $0.5998 / in 583,822 out 193,979 cacheRead 48,839,424 cache 98.8%; remediation3 running | Remediation2 full command gate green in worktree, but stop-gate review rejected before merge because package metadata and smoke proof were invalid | — | Remediation3 log `/Users/mohamedazab/.pidev-orchestrator/oc-h6-browser/run-20260612T153334.log` |
...
| 8 | H8 Goal & Loop Scheduler | `oc-h8-goal-loop` | dsv4-pro high | 🟡 | initial READY rejected; remediation1 rejected: $0.8411 / in 909,073 out 206,990 cacheRead 73,251,200 cache 98.8%; remediation2 rejected: $0.6332 / in 582,488 out 193,452 cacheRead 58,347,776 cache 99.0%; remediation3 rejected: $0.6296 / in 789,692 out 143,304 cacheRead 44,522,240 cache 98.3%; remediation4 running | Remediation3 full command gate green in worktree, but stop-gate review rejected before merge because create-loop UI still cannot satisfy manual create/list/cancel proof | — | Remediation4 log `/Users/mohamedazab/.pidev-orchestrator/oc-h8-goal-loop/run-20260612T153841.log` |
