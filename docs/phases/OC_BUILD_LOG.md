...
| 5 | H5 Checkpoint & Rewind | `oc-h5-checkpoint` | dsv4-pro max | 🟡 | $0.5778 / in 544,726 out 204,438 cacheRead 44,947,072 cache 98.8%; remediation1 $1.0920 / in 1,059,997 out 270,774 cacheRead 109,058,048 cache 99.0%; remediation2 $0.3947 / in 512,758 out 116,583 cacheRead 19,365,760 cache 97.4%; remediation3 $0.4313 / in 392,276 out 195,973 cacheRead 24,880,128 cache 98.4%; remediation4 ordered | Full command gate green in `../ocx-h5`; stop gates rejected after remediation3; same-tree remediation ordered | — | Current reject reasons: restore still uses `git reset --hard`, blocks post-checkpoint untracked mutations instead of restoring them, staged state is not restored as staged, fork worktree uses checkpoint `HEAD` only and misses staged/unstaged/untracked snapshot state, dirty confirmation has no server-side override path |
