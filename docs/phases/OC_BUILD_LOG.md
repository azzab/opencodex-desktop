...
| 5 | H5 Checkpoint & Rewind | `oc-h5-checkpoint` | dsv4-pro max | 🟡 | $0.5778 / in 544,726 out 204,438 cacheRead 44,947,072 cache 98.8%; remediation1 $1.0920 / in 1,059,997 out 270,774 cacheRead 109,058,048 cache 99.0%; remediation2 $0.3947 / in 512,758 out 116,583 cacheRead 19,365,760 cache 97.4%; remediation3 running | Full command gate green in `../ocx-h5`; stop gates rejected; same-tree remediation ordered | — | Reject reasons: snapshot misses tracked/staged pre-turn state, unsafe stash/reset-hard restore, false file-backed reload test, unmanaged fork worktree, weak restore event proof |
