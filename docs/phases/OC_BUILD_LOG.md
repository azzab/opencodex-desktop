...
| M2.5 | Provider Experience Parity | `oc-m2-5-provider-ux` | dsv4-pro max | 🔵 | Pending | Dispatched 2026-06-13 in `../ocx-m2-5`; orchestrator review pending | — | Evidence paths included: `docs/reference-evidence/providers/`; live multi-provider proof deferred to M-PROOF |
| M3 | IDE Experience Parity | `oc-m3-ide` | dsv4-pro max | 🔵 | Pending | Dispatched 2026-06-13 in `../ocx-m3`; orchestrator review pending | — | Evidence paths included: `docs/reference-evidence/ide/`; Antigravity hang root-cause required |
| M4a | Mobile Pairing Host | `oc-m4a-pairing` | dsv4-pro max | 🔵 | Pending | Dispatched 2026-06-13 in `../ocx-m4a`; orchestrator review pending | — | Opt-in TLS LAN listener, QR pairing, device scopes; manual phone proof deferred to M-PROOF if automated gates pass |
