...
| 6 | H6 Browser Automation Sidecar | `oc-h6-browser` | dsv4-pro max | 🟡 | initial READY rejected: $0.5786 / in 538,383 out 233,780 cacheRead 38,910,848 cache 98.6%; remediation1 rejected: $0.5525 / in 706,017 out 150,481 cacheRead 31,565,952 cache 97.8% | Full command gate green in remediation1, but orchestrator stop-gate review rejected before merge because the real Playwright smoke path was unavailable | — | No installed/lazy Playwright module path, no runnable real-browser smoke from app/test env, and evidence store lacks required contracts/IPC integration; remediation2 required |
