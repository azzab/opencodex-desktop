...
| M2 | Provider Auth & Model Discovery | `oc-m2-providers`; retry `oc-m2-providers-r2` | dsv4-pro max | ✅ | $4.6554 total: initial $0.9801 / in=693,450 out=329,545 cacheRead=108,061,184 cache 99.4%; remediation1 no-tree-change $0.3687 / in=544,068 out=108,062 cacheRead=10,493,952 cache 95.1%; retry $0.2603 / in=272,730 out=130,584 cacheRead=7,742,848 cache 96.6%; fixture scrub $0.3857 / in=281,748 out=180,828 cacheRead=29,192,448 cache 99.0%; narrow cleanup $0.2005 / in=298,525 out=55,981 cacheRead=6,047,872 cache 95.3%; custom-provider remediation $0.6220 / in=680,471 out=194,292 cacheRead=43,301,888 cache 98.5%; OAuth remediation $0.2809 / in=250,073 out=168,213 cacheRead=7,108,480 cache 96.6%; safeStorage migration remediation $0.3744 / in=416,948 out=122,243 cacheRead=23,923,072 cache 98.3%; custom-provider catalog remediation $0.4637 / in=567,341 out=151,502 cacheRead=23,482,496 cache 97.6%; UI copy remediation $0.3011 / in=412,913 out=82,831 cacheRead=13,640,832 cache 97.1%; OAuth UI remediation failed gate $0.3428 / in=481,460 out=83,504 cacheRead=16,746,624 cache 97.2%; typecheck cleanup $0.0752 / in=140,315 out=12,448 cacheRead=921,344 cache 86.8% | Merged to `main`; post-merge full gate green: root typecheck/lint/tests (154 files/1317 tests), Kun typecheck/tests (58 files passed / 1 skipped, 658 passed / 4 skipped), build, `git diff --check`; focused provider/security tests 6 files/169 tests; strict secret-literal grep 0 hits. | `35266e3` | Lane commits `3093aa7` + `c32b797`. Live OpenRouter OAuth, real DeepSeek key validation, masked UI proof, and clean `config.json` audit remain deferred to M-PROOF per operator authorization before release claims. |
| M-B.0 | Evidence Packs (providers + ide) | — (orchestrator) | gpt-5.5 high | ✅ | Orchestrator only; no pidev cost | Evidence packs committed: `docs/reference-evidence/providers/EVIDENCE.md`, `docs/reference-evidence/ide/EVIDENCE.md`, VS Code installed-reference screenshot; sources cite official docs/GitHub/Marketplace and local installed manifests | `9720bc2` | Local webview capture was limited by VS Code focus/extension-host behavior, so the pack records installed-version proof plus official behavior sources; workers must map every P1 row or document gaps |
| M2.5 | Provider Experience Parity | `oc-m2-5-provider-ux`; retries `oc-m2-5-provider-ux-r2`, `oc-m2-5-provider-ux-r3` | dsv4-pro max | ✅ | $2.4039 total: initial $0.6256 / in=608,827 out=223,575 cacheRead=45,858,304 cache 98.7%; incomplete remediation $0.5158 / in=735,345 out=92,665 cacheRead=31,801,856 cache 97.7%; aborted wrong-cwd recovery $0.3264 / in=600,573 out=43,546 cacheRead=7,525,120 cache 92.6%; r2 $0.6035 / in=573,273 out=152,394 cacheRead=61,117,184 cache 99.1%; r3 $0.3326 / in=314,141 out=126,008 cacheRead=23,823,744 cache 98.7% | Merged to `main`; post-merge full gate green: root typecheck/lint/tests (161 files/1471 tests), Kun typecheck/tests (58 files passed / 1 skipped, 670 passed / 4 skipped), build, `git diff --check`. Source review accepted: provider catalog/UX and per-task routing are wired through the runtime turn path, per-provider keys are injected only via `KUN_PROVIDER_KEYS_JSON`, `providerKeys` is removed from persisted Kun config schema/writes, logs/hooks redact the env payload, and strict secret-pattern scan found only fixture sentinels. | `d30ad15` | Lane commits/checkpoints `575b180`, `7020305`, `b84e28b`, `e24bc42`; rebase conflict repair preserved M4a mobile strings/API plus M2.5 provider strings/API. Live multi-provider proof remains deferred to M-PROOF. |
| M3 | IDE Experience Parity | `oc-m3-ide` | dsv4-pro max | ✅ | $0.7425 total: initial $0.5290 / in=362,197 out=335,026 cacheRead=22,068,224 cache 98.4%; lint remediation $0.1063 / in=186,291 out=19,174 cacheRead=2,370,688 cache 92.7%; Antigravity-doc remediation $0.1072 / in=164,655 out=26,053 cacheRead=2,182,656 cache 91.9% | Merged to `main`; post-merge full gate green: root typecheck/lint/tests (154 files/1317 tests), Kun typecheck/tests (58 files passed / 1 skipped, 658 passed / 4 skipped), build, `git diff --check`, VS Code typecheck/tests/build/package (5 files/40 tests, VSIX 47.6 KB). VSIX install proof green in VS Code and Cursor as `opencodex.opencodex-vscode@0.2.0`; Antigravity intentionally untouched per operator request, with reproducible fork-extension issue documented instead of fake workaround settings. | `d4d5931` | Lane commit `6628d8a`; evidence paths included `docs/reference-evidence/ide/`; live cross-client/operator smoke remains queued in M-PROOF |
| M4a | Mobile Pairing Host | `oc-m4a-pairing`; retry `oc-m4a-pairing-r2` | dsv4-pro max | ✅ | $2.1911 total: initial $0.7373 / in=621,867 out=253,420 cacheRead=67,958,272 cache 99.1%; remediation1 $0.7579 / in=967,261 out=157,263 cacheRead=55,249,408 cache 98.3%; remediation2 $0.3855 / in=558,862 out=91,610 cacheRead=17,290,240 cache 96.9%; focused retry $0.3104 / in=327,938 out=151,657 cacheRead=9,865,472 cache 96.8% | Merged to `main`; post-merge full gate green: root typecheck/lint/tests (158 files/1433 tests), Kun typecheck/tests (58 files passed / 1 skipped, 658 passed / 4 skipped), build, `git diff --check`. Source review accepted the focused retry: 32 real HTTPS `MobileTlsListener` integration tests prove authenticated runtime proxying, pairing-code exchange, token auth, route-scope denial, unauthenticated surface denial, and revoke behavior through the actual listener path. | `514abbd` | Lane checkpoints `eeb7f56` and `953f0d8`; physical phone/second-machine pairing proof is queued to `docs/M-PROOF-physical-device-pairing.md` and M-PROOF before release claims. |
| M4b | Mobile Companion App | `oc-m4b-mobile` | dsv4-pro high | 🟡 | $0.6398 / in=558,414 out=253,556 cacheRead=48,636,288 cache 98.9% | Command gate green after local dependency install (root typecheck/lint/tests 158 files/1433 tests; Kun typecheck/tests 58 files passed/1 skipped and 658 passed/4 skipped; build; `git diff --check`; mobile typecheck/tests 35; shared typecheck/tests 15), but source review rejected the READY output. | — | Same-session remediation ordered: QR scan was a stub, pairing used the wrong endpoint contract, cert-pinning was claimed but not enforced, simulator/device proof was absent, and SecureStore fallback needed fail-closed/test-only treatment. |
...
- 2026-06-13: M2 custom-provider catalog remediation completed with cost
  `$0.4637` and the worker reported a green full gate, but orchestrator source
  review rejected before rerunning the full gate. The functional save→refresh
  direction was corrected, but the validation-only button and success state
  still claimed model discovery (`Validate & Discover Models` and a stale
  `{{count}} models discovered` message). Ordered a narrow UI/i18n/test
  remediation on `oc-m2-providers-r2` so visible provider states match the new
  behavior in en/zh/ar and tests assert the copy.
- 2026-06-13: M2 UI copy remediation completed with cost `$0.3011`.
  Orchestrator independently verified focused M2 tests (7 files/183 tests) and
  the full command gate in `../ocx-m2`: root typecheck/lint/tests
  (154 files/1308 tests), Kun typecheck/tests (58 files passed / 1 skipped,
  658 passed / 4 skipped), build, and `git diff --check` all exited 0.
  Source review accepted the remaining automated stop gates, and the M2 lane
  was committed as `39e0be4`. Per the M2 Stop Gates and master orchestration
  rules, merge is blocked at the operator-only manual proof: real OpenRouter
  OAuth sign-in must connect/list models, a pasted DeepSeek key must validate,
  both must be masked in UI, and `config.json` must contain no key material.
...
- 2026-06-13: M2 OAuth-UI remediation resumed in the same `../ocx-m2`
  worktree after a clean rebase onto `main`. `pidev order oc-m2-providers-r2`
  warned that no saved live session existed and started a fresh worker under
  the same remediation id; no other live worker was present. The order targets
  the operator proof failure: OpenRouter PKCE exists in main/preload, but the
  UI hid the OAuth control behind `isOpenRouter && !hasKey`, so the sign-in
  control was not consistently visible/prominent. Live real-provider proof is
  queued to M-PROOF; automated OAuth UI, masked rendering, and no-secret gates
  remain required before merge.
- 2026-06-13: M2 OAuth-UI remediation reported READY with cost `$0.3428`,
  but orchestrator verification immediately failed `npm run typecheck` in
  `../ocx-m2`: `settings-section-providers.test.tsx` indexes typed locale JSON
  objects with a generic `string` at lines 966-968 (`TS7053`). This invalidates
  the worker's self-reported full-gate pass. Same-session steering was ordered
  on `oc-m2-providers-r2` to fix the type error without changing M2 scope and
  rerun the complete gate.
- 2026-06-13: M2 typecheck cleanup completed with cost `$0.0752` and only made
  the OAuth i18n-key test type-safe. Orchestrator independently reran the full
  lane gate in `../ocx-m2`, the focused provider/security tests (6 files / 169
  tests), and source-reviewed the persistent OpenRouter OAuth control. The lane
  was committed as `c32b797` on top of rebased M2 commit `3093aa7`, merged to
  `main` as `35266e3`, and the post-merge full gate was green on `main`.
  Operator-only live provider proof remains queued to M-PROOF.
- 2026-06-13: M-B.0 evidence packs were created and committed as `9720bc2`.
  VS Code `1.124.2` had Cline `3.89.2`, Kilo Code `7.3.45`, Roo Code
  `3.54.0`, Continue `1.2.22`, and OpenCodex `0.1.0` installed. Clean local
  webview capture was limited by VS Code focus/extension-host behavior, so the
  committed packs use installed-manifest proof plus official docs/GitHub/
  Marketplace behavior sources and explicitly record the limitation. M2.5 and
  M3 launcher prompts must include `docs/reference-evidence/providers/` and
  `docs/reference-evidence/ide/` respectively.
- 2026-06-13: Wave M-B dispatched after M2 and M-B.0 were merged: M2.5
  `oc-m2-5-provider-ux` in `../ocx-m2-5` with `--max`, M3 `oc-m3-ide` in
  `../ocx-m3` with `--max`, and M4a `oc-m4a-pairing` in `../ocx-m4a` with
  `--max`. Preflight passed for all three clean worktrees; global live-worker
  warnings during later dispatches were informational because the wrapper uses
  per-tree locks. Each launcher included its evidence pack path where required.
- 2026-06-13: M2.5 initial run `oc-m2-5-provider-ux` reported
  READY_FOR_ORCHESTRATOR_REVIEW with cost $0.6256 and a green mechanical gate,
  but orchestrator source review rejected it: `perTaskModel` was normalized and
  rendered in settings, but was not consumed by the chat send path, composer
  quick-switch, auto-routing, or Kun runtime. The named M2.5 stop gate requires
  per-task assignment to route a real turn to the assigned model, so remediation
  was ordered on the same session before merge.
- 2026-06-13: M2.5 same-session remediation cost $0.5158 but stopped
  mid-thought without `READY_FOR_ORCHESTRATOR_REVIEW`, leaving partial worker
  edits in `../ocx-m2-5`. A recovery `order` against the closed session
  incorrectly restarted in the main checkout and cost $0.3264 before the
  orchestrator killed it; the accidental untracked files in main were removed
  and main was verified clean. The partial M2.5 worktree output was checkpointed
  on the lane as `46fd35d` after a quick secret-pattern scan found only existing
  fixtures/env-var names, then fresh retry `oc-m2-5-provider-ux-r2` was
  dispatched with `--cwd ../ocx-m2-5 --max`.
- 2026-06-13: M2.5 retry `oc-m2-5-provider-ux-r2` cost $0.6035 and passed the
  full independent mechanical gate after the orchestrator restored an
  accidentally modified tracked tray asset (`src/asset/img/opencodex_tray.png`)
  from lane `HEAD`. Source review still rejected the lane: it added
  `providerKeys` to Kun config/schema/serve parsing and wrote safeStorage keys
  into Kun `dataDir/config.json`, which violates the stop gate requiring no
  provider key material in any `config.json`/export/log/persisted settings.
  The output was checkpointed as `cc6dd05`; security-only retry
  `oc-m2-5-provider-ux-r3` was dispatched to remove persisted provider keys and
  keep only ephemeral runtime key injection.
- 2026-06-13: M3 initial run `oc-m3-ide` cost $0.5290 and reported READY, but
  orchestrator verification failed at root lint after installing worktree
  dependencies: `clients/vscode/webview/sidebar.js` used `acquireVsCodeApi`
  without a lint-safe global declaration. Narrow remediation was ordered before
  any merge.
- 2026-06-13: M3 lint remediation cost $0.1063 and independently passed the
  full root/Kun/VS Code gate, but source review found `PUBLISHING.md`
  documented Antigravity workaround settings (`opencodex.activationMode` and
  `opencodex.disableStatusBar`) that were not declared in the manifest or
  implemented. A second narrow remediation was ordered to either implement the
  settings or remove the misleading workaround and placeholder issue link.
- 2026-06-13: M3 second remediation cost $0.1072 and removed the fake
  Antigravity settings/placeholder issue from the VS Code publishing docs. The
  lane was accepted and merged as `d4d5931` after a post-merge full gate on
  `main` passed: root typecheck/lint/tests, Kun typecheck/tests, app build,
  `git diff --check`, and VS Code typecheck/tests/build/package. The packaged
  VSIX installed into Visual Studio Code and Cursor as
  `opencodex.opencodex-vscode@0.2.0`; Antigravity was intentionally not
  modified because the operator had requested OpenCodex removal from
  Antigravity earlier.
- 2026-06-13: M4a initial run `oc-m4a-pairing` cost $0.7373 and had a green
  mechanical gate, but source review rejected it for stop-gate gaps: the QR UI
  generated local fake pairing codes and placeholder LAN hosts instead of using
  host-side pairing/listener IPC, listener audit events were not emitted, and
  scope tests mirrored local prefix arrays rather than proving listener
  enforcement. Security-sensitive remediation was ordered before merge.
- 2026-06-13: M4a first remediation cost $0.7579 and independently passed the
  full root/Kun/build/diff gate with 1376 root tests. It closed the fake QR,
  listener lifecycle, audit, and production-scope-test gaps, but source review
  still rejected the lane: the TLS LAN listener accepted scoped routes by
  returning `{ ok: true, note: proxy pending }` instead of serving/proxying the
  app-server protocol, so a paired phone could not list threads or answer
  approvals; and unauthenticated `GET /mobile/qr-payload` remained reachable on
  the listener despite the token-required surface rule and only a comment
  claiming localhost-only. A second remediation was ordered before merge.
- 2026-06-13: M4a second remediation cost $0.3855 and independently passed the
  full mechanical gate (root typecheck/lint/tests, Kun typecheck/tests, build,
  `git diff --check`) with 1401 root tests. Source code removed the LAN
  `/mobile/qr-payload` handler and added runtime proxying via injected
  `runtimeRequest`, but source review rejected the tests: the runtime-proxy
  tests called `mockRuntimeRequest` directly instead of sending authenticated
  requests through the actual `MobileTlsListener` auth, scope, and proxy path.
  The partial output was checkpointed on the lane as `eeb7f56`; focused retry
  `oc-m4a-pairing-r2` was dispatched to add real listener integration tests and
  fix any code needed by that proof.
- 2026-06-13: M4a focused retry `oc-m4a-pairing-r2` cost $0.3104 and was
  accepted. It added 32 real HTTPS listener integration tests that drive
  authenticated requests through `MobileTlsListener`, proving runtime proxying,
  pairing-code exchange, token auth, route-scope denial, unauthenticated
  surface denial, and revoke behavior without calling `runtimeRequest`
  directly. The lane was squash-merged to main as `514abbd`; the post-merge
  full gate passed (root typecheck/lint/tests with 158 files/1433 tests, Kun
  typecheck/tests with 58 files passed/1 skipped and 658 tests passed/4
  skipped, build, `git diff --check`). The tracked tray asset was restored when
  tests temporarily dirtied it; the physical phone/second-machine proof remains
  queued to M-PROOF.
- 2026-06-13: M4b `oc-m4b-mobile` was dispatched in fresh worktree
  `../ocx-m4b` from main commit `f5f52ac` with `--thinking high` after M4a
  merged and the M4a ledger was committed. Preflight passed with a clean tree;
  the live-worker warning was accepted because M2.5 r3 was isolated in
  `../ocx-m2-5` and the wrapper enforces per-tree locks. M5 was not dispatched
  because its runner dependency remains all of M-B merged, including M2.5.
- 2026-06-13: M2.5 security retry `oc-m2-5-provider-ux-r3` cost $0.3326 and
  was accepted after independent review. The fix removed `providerKeys` from
  persisted Kun `serve` config/schema/writes, moved per-provider keys to
  spawn-time `KUN_PROVIDER_KEYS_JSON`, added log/hook redaction, and preserved
  per-task `providerId` routing through renderer request -> turn record ->
  `AgentLoop` -> provider-specific `ModelClient`. The rebased lane needed
  orchestrator conflict repair in provider/mobile i18n/API surfaces plus one
  M4a `mobileAccess` test-fixture field. Rebased lane gate passed, then the
  lane was squash-merged to main as `d30ad15`; post-merge full gate passed
  (root typecheck/lint/tests with 161 files/1471 tests, Kun typecheck/tests
  with 58 files passed/1 skipped and 670 tests passed/4 skipped, build,
  `git diff --check`). Strict secret-pattern scan found fixture sentinels only.
- 2026-06-13: M4b `oc-m4b-mobile` initial READY output cost $0.6398. After
  installing dependencies in the fresh worktree, the command gate passed
  (root typecheck/lint/tests with 158 files/1433 tests; Kun typecheck/tests
  with 58 files passed/1 skipped and 658 tests passed/4 skipped; build;
  `git diff --check`; mobile typecheck/tests with 35 tests; shared
  typecheck/tests with 15 tests). Orchestrator source review rejected the lane:
  `PairScreen` exposed a QR button stub instead of a real camera scanner,
  pairing posted to `/v1/pairing/exchange` while M4a exposes `/mobile/pair`,
  the app stored but did not enforce the certificate fingerprint, simulator or
  device proof was absent, README copy overclaimed verification, and token
  storage had a silent in-memory fallback outside tests. Same-session
  remediation was ordered; physical-device smoke remains queued to M-PROOF, but
  automated/simulator proof and honest cert-pinning behavior remain M4b gates.
