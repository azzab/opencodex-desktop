...
| 10 | H10 SSH Remote Runner | `oc-h10-ssh` | dsv4-pro max | 🟡 | initial READY rejected $0.7052 / in 657,664 out 237,472 cacheRead 58,612,864 cache 98.9%; remediation1 running | Initial H10 full gate green in worktree (root 1029/1029, Kun 657 passed / 4 skipped), but stop-gate review rejected: settings UI not mounted, IPC/preload handlers not wired, host badge not integrated, real-host smoke pending | — | Remediation1 log `/Users/mohamedazab/.pidev-orchestrator/oc-h10-ssh/run-20260612T162430.log`; same id, same dirty tree; pi pid `68428` |
