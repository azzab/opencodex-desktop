...
| M2.5 | Provider Experience Parity | `oc-m2-5-provider-ux`; retries `oc-m2-5-provider-ux-r2`, `oc-m2-5-provider-ux-r3` | dsv4-pro max | 🟡 | $2.0713 total: initial $0.6256 / in=608,827 out=223,575 cacheRead=45,858,304 cache 98.7%; incomplete remediation $0.5158 / in=735,345 out=92,665 cacheRead=31,801,856 cache 97.7%; aborted wrong-cwd recovery $0.3264 / in=600,573 out=43,546 cacheRead=7,525,120 cache 92.6%; r2 $0.6035 / in=573,273 out=152,394 cacheRead=61,117,184 cache 99.1% | Initial worker run reviewed: full mechanical gate green in `../ocx-m2-5` (root typecheck/lint/tests 155 files/1327 tests, Kun typecheck/tests 58 files passed / 1 skipped and 658 tests passed / 4 skipped, build, `git diff --check`, strict secret-literal grep 0 hits), but source review failed because per-task assignments were only persisted/rendered. Same-session remediation stopped mid-thought; partial output was checkpointed as `46fd35d`. Retry r2 passed the full independent mechanical gate (root typecheck/lint/tests 156 files/1352 tests, Kun typecheck/tests 58 files passed / 1 skipped and 658 tests passed / 4 skipped, build, `git diff --check`) and wired per-task routing, but source review rejected it for writing safeStorage provider keys into Kun `dataDir/config.json` via `providerKeys`. Output checkpointed as `cc6dd05`; security-only retry r3 dispatched. | — | Evidence paths included: `docs/reference-evidence/providers/`; live multi-provider proof deferred to M-PROOF |
