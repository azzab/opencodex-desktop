...
| 11 | H11 Upstream Wave-8 Ports | `oc-h11-upstream` | dsv4-pro high | 🔵 | initial READY rejected $1.0572 / in 626,354 out 347,459 cacheRead 133,089,024 cache 99.5%; remediation running | Initial independent full gate green, but 8D stop-gate review failed; remediation pending in `../ocx-h11` | — | 8A/8C/8D commits present; remediate incomplete 8D store/startup port and replace weak perf proof |
