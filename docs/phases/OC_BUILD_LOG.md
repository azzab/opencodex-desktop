...
| M4b | Mobile Companion App | `oc-m4b-mobile` | dsv4-pro high | 🔵 | Running; cost pending | Dispatched in `../ocx-m4b` after M4a merge; preflight passed with clean tree and per-tree isolation while M2.5 r3 continued in `../ocx-m2-5`. | — | Expo/RN thin mobile client; physical-device smoke is queued to M-PROOF, simulator/automated proof acceptable overnight |
