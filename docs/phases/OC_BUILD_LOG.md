...
| 11 | H11 Upstream Wave-8 Ports | `oc-h11-upstream` | dsv4-pro high | 🔵 | dispatched 2026-06-12; cost pending | Worker running in `../ocx-h11`; verification pending | — | 8A → 8C → 8D order; run log `/Users/mohamedazab/.pidev-orchestrator/oc-h11-upstream/run-20260612T195444.log` |
