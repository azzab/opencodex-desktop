...
export type ManagedLogFilePrefix = 'opencodex-desktop' | 'kun'
...
const MANAGED_LOG_FILE_PREFIXES: ManagedLogFilePrefix[] = ['opencodex-desktop', 'kun']
...
async function writeLogLine(level: LogLevel, category: string, message: string): Promise<void> {
  ...
  await appendManagedLogLine('opencodex-desktop', line)
}
