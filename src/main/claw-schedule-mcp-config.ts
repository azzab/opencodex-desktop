...
const CLAW_SCHEDULE_MCP_MARKER_START = '# OpenCodex Desktop plugin:mcp:claw-schedule START'
const CLAW_SCHEDULE_MCP_MARKER_END = '# OpenCodex Desktop plugin:mcp:claw-schedule END'
