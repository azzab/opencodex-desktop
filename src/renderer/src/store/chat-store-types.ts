...
export type SettingsRouteSection = 'general' | 'write' | 'agents' | 'skill' | 'mcp' | 'shortcuts' | 'claw' | 'providers'
...
export type ChatState = {
  ...
  applyI18nFromSettings: (locale: AppSettingsV1['locale']) => Promise<void>
