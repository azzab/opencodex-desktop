...
Do not store API keys, OAuth tokens, `.env` values, private customer data, or private infrastructure details in this notice, README files, issue reports, screenshots, or external model prompts.
